...
-- CreateEnum
CREATE TYPE "Colour" AS ENUM ('BLACK', 'BLUE', 'BROWN', 'GREEN', 'GREY', 'ORANGE', 'PINK', 'PURPLE', 'RED', 'SILVER', 'WHITE', 'YELLOW', 'GOLD');
...
CREATE TABLE "classifieds" (
    ...
    "status" "ClassifiedStatus" NOT NULL DEFAULT 'LIVE',
...
-- CreateTable
CREATE TABLE "_ClassifiedToModel" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_ClassifiedToModel_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "customer_lifecycle_customer_id_created_at_idx" ON "customer_lifecycle"("customer_id", "created_at");
...
-- CreateIndex
CREATE INDEX "_ClassifiedToModel_B_index" ON "_ClassifiedToModel"("B");
...
-- AddForeignKey
ALTER TABLE "_ClassifiedToModel" ADD CONSTRAINT "_ClassifiedToModel_A_fkey" FOREIGN KEY ("A") REFERENCES "classifieds"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_ClassifiedToModel" ADD CONSTRAINT "_ClassifiedToModel_B_fkey" FOREIGN KEY ("B") REFERENCES "models"("id") ON DELETE CASCADE ON UPDATE CASCADE;
